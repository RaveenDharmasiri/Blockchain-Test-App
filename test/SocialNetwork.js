...
contract('SocialNetwork', ([deployer, author, tipper]) => {
	...
	describe('posts', async () => {
		...
		it('allows users to tip', async () => {
			...
			// Track author balance before tipping
			...
			assert.equal(newAuthorBalance.toString(), expectedBalance.toString(), 'Author received funds');

			// FAILURE : Triest to tip a post that does not exist
